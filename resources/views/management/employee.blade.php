            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                ...
                <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
                    <li class="relative before:content-['\ea54'] before:font-remix ltr:before:-right-1 rtl:before:-left-1  before:absolute before:text-[18px] before:-top-[3px] ltr:pr-4 rtl:pl-4 before:text-slate-400 dark:text-zink-200">
                        <a href="#!" class="text-slate-400 dark:text-zink-200">{{ Session::has('name') ? Session::get('name') : 'No user selected' }}</a>
                    </li>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500 Action">
                                            <div class="flex gap-3">
                                                ...
                                                <a href="#" data-modal-target="deleteModal-{{ $employee->employeeNo }}" class="flex items-center justify-center transition-all duration-200 ease-linear rounded-md size-8 remove-item-btn bg-slate-100 text-slate-500 hover:text-custom-500 hover:bg-custom-100 dark:bg-zink-600 dark:text-zink-200 dark:hover:bg-custom-500/20 dark:hover:text-custom-500">
                                                ...
                                                <form action="{{ route('updateEmployee/{employeeNo}', ['employeeNo' => $employee->employeeNo]) }}" method="POST" id="updateEmployeeForm-{{ $employee->employeeNo }}" enctype="multipart/form-data">
                                                    ...
                                                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                                                        ...
                                                        <div class="md:col-span-2">
                                                            ...
                                                            <input type="text" id="updateRole-{{ $employee->employeeNo }}" name="employeeRole" value="{{ $employee->employeeRole }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 dark:bg-zink-700 dark:text-zink-100 w-full" placeholder="e.g. Agent, Caretaker" required>
                                                        </div>
                                                        <div class="xl:col-span-12">
                    ...
                    <div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                        ...
                        <div class="xl:col-span-12">
                            ...
                            <input type="text" id="employeeRole" name="employeeRole"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                placeholder="e.g. Agent, Caretaker" required="">
                        </div>
