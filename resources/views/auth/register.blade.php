    ...
    <div class="mb-0 w-screen lg:w-[500px] card shadow-lg border-none shadow-slate-100 relative">
        <div class="!px-10 !py-12 card-body">
            ...
            <div class="mt-8 text-center">
                ...
                <p class="text-slate-500 dark:text-zink-200">Get your free BUMA rentals account now</p>
            </div>
            ...
            <form action="{{ route('register') }}" class="mt-10" method="POST">
                ...
                <div class="mb-3">
                    <label for="phonenumber-field" class="inline-block mb-2 text-base font-medium">Phone Number</label>
                    <input type="text" name="phonenumber" id="phonenumber-field" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter Phone Number">
                </div>
                <div class="mb-3">
                    <label for="rentalname-field" class="inline-block mb-2 text-base font-medium">Rental Business Name</label>
                    <input type="text" name="rentalname" id="rentalname-field" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter Rental Business Name">
                </div>
                <div class="mb-3">
                    <label for="role-field" class="inline-block mb-2 text-base font-medium">Role</label>
                    <input type="text" name="role" id="role-field" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter Role">
                </div>
                <div class="mb-3">
                ...
                <p class="italic text-15 text-slate-500 dark:text-zink-200">By registering you agree to the BUMA rentals <a href="#!" class="underline">Terms of Use</a></p>
                <div class="mt-10">
